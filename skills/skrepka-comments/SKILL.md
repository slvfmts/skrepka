...
из-за закрытого треда, соседнего комментария, именованного диапазона или перевода
строки в новом тексте. В отказе есть ссылка `?disco=` на мешающий тред — дай её

...
description: Отработать комментарии в Google Doc — прочитать треды, ответить по делу и внести правки в текст, не убивая якоря комментариев. Резолвит треды только человек.
---
